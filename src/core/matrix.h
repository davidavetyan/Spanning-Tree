...
public:
    CMatrix() = default;
    CMatrix(int nRow, int nCol) : m_aData(nRow * nCol), m_nDim(nCol) {}
...
public:
    T& operator()(int nRow, int nCol) { return m_aData[nRow * m_nDim + nCol]; }
    T const& operator()(int nRow, int nCol) const { return m_aData[nRow * m_nDim + nCol]; }
